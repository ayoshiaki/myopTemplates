...
my $intron_lengths =`cat ghmm/dataset/intron_length.length`;
$intron_lengths =~ s/(.+):\t//g;
...
$transitions{make_transition_str( "N", "start" )} =  $pforward/$intergenic_length - $final_state_prob/2;
$transitions{make_transition_str( "N", "rstop" )} = (1-$pforward)/$intergenic_length - $final_state_prob/2;
...
$transitions{make_transition_str("N", "N")} = 1-1.0/$intergenic_length;
