...
$transitions{make_transition_str( "N", "start" )} = $pforward * ((1.0/$intergenic_length) + $final_state_prob)/2.0;
$transitions{make_transition_str( "N", "rstop" )} = (1.0 - $pforward) * ((1.0/$intergenic_length) + $final_state_prob)/2.0;
